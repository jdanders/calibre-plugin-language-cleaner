...
lord_list=[
  ...
  #My God
  (re.compile(r'(?<!(..\bin|..\bis|..\bto|..\bof|from|..\bon)\W)my '+s_lord+r's?\b(?! \w)',re.I),"my goodness",first_case),
  #Oh God
  ...
  #In God's name
  (re.compile(r'(?<=where\W)\bin\W'+s_lord+'\W*s name',re.U+re.I),"in the world",first_case),
  (re.compile(r'\bin '+s_lord+'\W*s name',re.U+re.I),"for goodness sake",first_case),
  #in God
  ...
  (re.compile(r'([^ ]|\. +)'+s_lord+' knows',re.I),r"\1Heaven knows",False),
  (re.compile(r''+s_lord+' knows',re.I),"heaven knows",False),
  #For God's sake
  (re.compile(r'\bfor '+s_lord+'\W*s sake',re.U+re.I),"for goodness sake",first_case),
  #Godforsaken
...
vain_lord_list=[
  ...
  (re.compile(r'(?<=([\.?!,]\W\W|..\"|”|“|.\W\W))'+s_lord+'s?(?=[\.,?!])',re.U+re.I),"goodness",keep_case),
  #Jesus and/or Christ
...
re_list = [
  ...
  (re.compile(r'\b[tT][iI][tT][sS]?\b(?! for)(?!-tat)(?!-ul)',re.I),'belly',keep_case),
  ...
  #kiss ass
  (re.compile(r'kissin[^\s]\Wass(es)?\b',re.U+re.I),"kissing up",keep_case),
  ...
  #Give a damn
  (re.compile(r'give(\W+.{0,10}?)a(\W+)(?:gods? *)?damn',re.I),'care',keep_case),
  (re.compile(r'gives(\W+.{0,10}?)a(\W+)(?:gods? *)?damn',re.I),'cares',keep_case),
  #Damn near
  ...
  #a damn
  (re.compile(r'(?<=\b[aA] )(?:gods? *)?damn(?:ed)',re.I),'darn',keep_case),
  ...
  (re.compile(r'\b(?:gods? *)?damn(?= (him|his|her|you|next|the|you))',re.I),'curse',keep_case),
  #Word by itself
  ...
  #########################################
  #Son of a bitch
  (re.compile(r's[UuOo]n(s)?([ -])?[OoUu][FfVv]([ -])?(a)?([ -])?bitch(e)?',re.I),'jerk',keep_case),
  #verb
  ...
  (re.compile(r'(?<=(n([^\s]|o)t ))bitch',re.U+re.I),'complain',keep_case),
  #A bitch
  ...
  # f-bomb
  #########################################
  (re.compile(r'(m[OoUu]th[AaEe]r?)?fuck',re.I),'zxsa',keep_case), #clean up script...
  (re.compile(r'(m[OoUu]th[AaEe]r?)?fook',re.I),'zxsa',keep_case), #clean up script...
  #f yourself
  ...
  #f's
  (re.compile(r'zxsas(?=\W(around|with|on\b|up\b|over|under|through))',re.U+re.I),"messes",first_case),
  #f'in
  (re.compile(r'zxsa(?=(in[^\s]?|s)?\W(around|with|on\b|up\b|over|under|through))',re.U+re.I),"mess",first_case),
  ###f'ing A
  (re.compile(r'zxsain[^\s]? a\b',re.U+re.I),"unbelievable",first_case),
  (re.compile(r' (zxsain[^\s]?(?: well)?)(\W*.)',re.U+re.I),"",drop_first_match),
  (re.compile(r'(zxsain[^\s]? (?:well)?)(\W*.)',re.U+re.I),"",drop_first_match),
  ...
  #f your/his/her/etc
  (re.compile(r'zxsa(?=(ed)?\W(your|our|her|his|us|this|that|the\b|their|those|these|them|[^\s]em|for|a\b))',re.U+re.I),"harass",keep_case),
  #f'ed
  ...
  #verb
  (re.compile(r'zxsa(?=\W(around|with|on\b|up\b|over|under|through))',re.I),"mess",first_case),
  ...
  #########################################
  #dick around
  (re.compile(r'dick(?=(in[^\s])?\W(around|with|on\b|up\b|over|under|through))',re.U+re.I),"mess",first_case),
  #dickin['/g]
  ...
  #what the hell[.?!]
  (re.compile(r'what\Wthe\Whell(?=[\.?!\,])',re.I),'what the heck',keep_case),
  #(in) the hell
  (re.compile(r'(?: in)? (the)\Whell(?=[ \.?!\,])(?! in)(?! your)(?! out)(?! I\b)(?! of\b)(\W*.)',re.I),'*removed*',drop_first_match),
  (re.compile(r'(?:in\W)?(the)\W+hell (?!in)(?!your)(?!out)(?!I\b)(?!of\b)(\W*.)',re.I),'*removed*',drop_first_match),
  ...
  (re.compile(r'L[Ii][Kk][Ee]\W[Hh][Ee][Ll][Ll]'),'not a chance',keep_case),
